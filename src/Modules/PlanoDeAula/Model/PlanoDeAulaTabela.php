<?php
namespace CasteloBranco\Cemet\Modules\PlanoDeAula\Model;
use CasteloBranco\Cemet\Interfaces\ITabela;
/**
 * Description of PlanoDeAulaTabela
 *
 * @author ricardo
 */
class PlanoDeAulaTabela implements ITabela{
    ...
    public static function find($id) {
        ...
        return \CasteloBranco\Cemet\Factory\Creator::
                factoryMethod(PlanoDeAula::class, $tr->find($id));
    }
